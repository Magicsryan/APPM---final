              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="proses-register.php">
                    ...
                    <div class="form-group">
                      <input name="username" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan User Name Anda..." required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input name="telp" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan No Telp Anda..." required>
                    </div>

                    <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color: #252A34; border-color: #252A34;">
                      Register
                    </button>
                    <hr>
                    <a href="index.php" class="btn btn-success btn-user btn-block">
                      <i class="fa fa-laptop fa-fw"></i> Sudah Punya Akun? Silahkan Login</a>
                  </form>
                  <hr>
                </div>
              </div>
